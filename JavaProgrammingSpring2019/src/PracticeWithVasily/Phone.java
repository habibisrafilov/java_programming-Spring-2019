...
//Write a class Phone class a constructor that accepts two parameters: 
...
public class Phone {
	...
	private boolean  addValueServices;
	
	public Phone(String phoneNumber, boolean  addValueServices) {
		this.phoneNumber = phoneNumber;
		this.addValueServices = addValueServices;
	}
